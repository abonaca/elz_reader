...
Due to their cold kinematics, even subtle gravitational perturbations will leave a prominent observational signature (e.g., gaps due to encounters with dark matter subhalos, fans due to encounters with the bar) \citep[e.g.,][]{bonaca2019a}.
...
Figure~\ref{fig:sky} shows the sky positions of the six most compelling associations, with equatorial coordinates in the top panel and Galactic in the bottom panel.

...
With these proper motions we can finally compute stream integrals of motion (e.g., energies, angular momenta) as has been done for globular clusters and stars to identify clustered objects that arrived in the Milky Way together.

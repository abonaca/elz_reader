...
With little metallicity variation within either Sylgr or Phoenix \citep{ibata2019, s5nature}, these streams likely originate from globular clusters hosted by the progenitor of Indus and Jhelum.
...
Cetus is a coherent, $XX\deg$ wide stream \citep{newberg2009} {\color{red} is is really a stream, or more of a cloud?}.  Triangulum and Willka Yaku also overlap with Cetus spatially, but they are each only $0.25\deg$ wide.
